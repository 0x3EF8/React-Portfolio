...
import pfp from "../IMG_20240105_171417.jpg";
import {
  Bars3Icon,
  XMarkIcon,
  SunIcon,
  ...
  return (
    <div>
     ...
     <div className="flex lg:flex-1">
            <p className="-m-1.5 p-1.5 font-semibold custom-text-color">
              My App
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight sm:text-6xl custom-text-color">
  Pat
</h1>
<p className="mt-6 text-2xl leading-8 custom-text-color">
  <TypeAnimation
    sequence={[
  ...
  />
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                    Hi, I'm Pat from the Philippines, passionate about learning front-end development. Eager to grow and contribute in the tech world through continuous improvement and dedication.
                  </p>
                </div>
<div className="mt-10 flex items-center justify-center gap-x-4">
                  <button className="btn btn-outline btn-square custom-text-color">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      className="h-8 w-8 custom-text-color"
                      viewBox="0 0 16 16"
                    >
